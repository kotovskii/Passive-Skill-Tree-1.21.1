...
public class PSTTags {
    public static class DamageTypes {
        public static final TagKey<DamageType> IS_MAGIC = net.neoforged.neoforge.common.Tags.DamageTypes.IS_MAGIC;
    }
    ...
    public static class Items {
        ...
        public static final TagKey<Item> JEWELRY = ItemTags.create(ResourceLocation.fromNamespaceAndPath("c", "curios/jewelry"));
