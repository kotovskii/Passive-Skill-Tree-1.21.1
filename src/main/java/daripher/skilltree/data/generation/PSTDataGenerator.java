...
public class PSTDataGenerator {
    ...
    public static void onGatherData(GatherDataEvent event) {
        ...
        dataGenerator.addProvider(includeServer, new PSTLootTablesProvider(dataGenerator, lookupProvider));
        ...
        dataGenerator.addProvider(includeServer, new PSTRecipesProvider(dataGenerator, lookupProvider));
