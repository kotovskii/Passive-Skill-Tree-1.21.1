...
public class WisdomScrollItem extends Item {
    ...
    public @NotNull InteractionResultHolder<ItemStack> use(@NotNull Level level, Player player, @NotNull InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ...
            PacketDistributor.sendToPlayer((ServerPlayer) player, new SyncPlayerSkillsMessage(player));
    ...
    @Override
    public void appendHoverText(@NotNull ItemStack itemStack, TooltipContext context, List<Component> components, @NotNull TooltipFlag tooltipFlag) {
